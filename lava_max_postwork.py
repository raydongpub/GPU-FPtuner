...
if dyblock_enabled == 1:
  subprocess.call(['cd ' + ' ./cuda_bench/lavaMD; make clean;' + 'make C_FLAG+=-DRD_WG_SIZE_0_0=' + block_list[0] + '; ./lava_dd -boxes1d 24'], shell=True)
else:
    ...
    for cur_var in comp_vars[func]:
          ...
          for stmt in run_program:
            ...
            if "gettimeofday(&end_t" in stmt:
              ...
              if is_single:
                ...
                for line in cmp_y:
                  wline.write(line+"\n")
              elif cur_var == "d_fv_z" and is_single==False:
      ...
      #  #run the translator for the original program
        if is_skip_for_var_combo==False:
          if dyblock_enabled == 1:
            subprocess.call(['cp ' + "run_program.run" + ' ./cuda_bench/lavaMD/lava_dd.cu;' + ' cd ' + ' ./cuda_bench/lavaMD; make clean;' + 'make C_FLAG+=-DRD_WG_SIZE_0_0=' + block_list[bl_off] + '; ./lava_dd -boxes1d 24'], shell=True)
            bl_off += 1
          else:
